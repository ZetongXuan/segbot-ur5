...
object_loc = [[7.5, 0.4], [7.5, 0.2], [7.5, 0], [7.5, -0.2], [7.4, -0.4]]
54
place_loc = [[0, 3.6], [0, 3.6], [0, 3.6], [0, 3.6], [0, 3.6]]
place_orien = [[0, 0, -0.7071, -0.82], [0, 0, -0.7071, -0.82], [0, 0, -0.7071, -0.82], [0, 0, -0.7071, -0.82], [0, 0, -0.7071, -0.82]]
load_GPT3 = np.load('/home/yan/catkin_ws/src/segbot-ur5/tamp_perception/src/output.npy')
load_GPT3 = load_GPT3.tolist()
place_ee_loc = load_GPT3
